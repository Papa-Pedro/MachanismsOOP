...
protocol ArrayCollectionControllerDelegate {
    func getDeterminant(_ controller: ArrayCollectionViewController, determinant: ResultDeterminant)
}
...
class ArrayCollectionViewController: UICollectionViewController {
    ...
    @IBAction func cancel(_ sender: Any) {
        ...
        delegate?.getDeterminant(self, determinant: workWithMatrix.determinantArray(array: matrixVariable.arrayOfElements, sizeMatrix: matrixVariable.size)) //делегируем
    }
    //перед созданием
